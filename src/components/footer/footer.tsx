            ...
            <footer className='footer'>
                ...
                <div className="footerItem">
                    <div className="footerImage">
                        <img src={require("../../assets/icon_temperature_info.png")} alt="image" />
                    </div>
                ...
                <div className="footerItem">
                    <div className="footerImage">
                    <img src={require("../../assets/icon_precipitation_info.png")} alt="image" />
                    </div>
                    <div className="footerInfo">
                ...
                <div className="footerItem">
                    <div className="footerImage">
                    <img src={require("../../assets/icon_humidity_info.png")} alt="image" />
                    </div>
                    <div className="footerInfo">
                ...
                <div className="footerItem">
                    <div className="footerImage">
                    <img src={require("../../assets/icon_wind_info.png")} alt="image" />
                    </div>
                    <div className="footerInfo">
                ...
                <div className="footerItem">
                    <div className="footerImage">
                    <img src={require("../../assets/icon_visibility_info.png")} alt="image" />
                    </div>
                    <div className="footerInfo">
